    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <!-- Language Switch -->
                <div class="flex items-center gap-2 mr-6 text-sm">
                    <a href="{{ route('lang.switch', 'es') }}" class="hover:underline">ES</a>
                    <a href="{{ route('lang.switch', 'en') }}" class="hover:underline">EN</a>
                    <a href="{{ route('lang.switch', 'fr') }}" class="hover:underline">FR</a>
                    <span class="text-xs opacity-60">({{ strtoupper(app()->getLocale()) }})</span>
                </div>
